...
class ScoringStrategy:
    ...
    @classmethod
    def update_player_ratings(cls, jeu: Game):
        ...
        jeu.player1.elo, jeu.player2.elo = cls.calculate_new_ratings(jeu.player1.elo, jeu.player2.elo, player_a_won=(jeu.player1 == jeu.winner))
